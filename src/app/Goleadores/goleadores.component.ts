...
export class GoleadoresComponent implements OnInit {
  ...
  getData() {
    ...
    //https://apiv2.allsportsapi.com/football/?met=Fixtures&APIkey=12e79df20c18bc08d9813167a58ba65206514ff57687bb63f3888fcd697b2fb2&from=2024-06-14&to=2024-06-18
    axios.get(apiUrl)
      .then(response => {
